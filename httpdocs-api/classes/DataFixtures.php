<?php
    ...
    require_once $_SERVER['DOCUMENT_ROOT'] . '/classes/RankingService.php';
        ...
        */
        public function updateResult($arrParams, $strFormat='json')
        {
            ...
            $strSql = "SELECT fix_id,
                        ...
                        fix_played_date,
                        comp_format,
                        comp_rankings_weight                              
                        FROM competition_fixture
                        JOIN competition_type ON fix_competition = comp_type_id 
                        WHERE fix_id = ?
                        ";            
            ...
            if ($arrFixture['comp_format'] == 'KO' && $arrParams['awayScore'] == $arrParams['homeScore'])
            {
            ...
            else
            {
                ...
                $objRankings = new RankingService();
                
                // If the fixture was already played before, update the fixture, if not, create it in the rankings service.
                if ($arrFixture['fix_played'] == 1)
                {                           
                    $objRankings->updateGame($arrData);
                }
                else
                {
            ...
            if ($arrFixture['comp_format'] == 'LEAGUE')
            {
            ...
            else if ($arrFixture['comp_format'] == 'KO') 
            {
